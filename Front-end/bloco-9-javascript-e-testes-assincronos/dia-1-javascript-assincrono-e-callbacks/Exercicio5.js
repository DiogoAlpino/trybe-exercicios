...
const sendMarsTemperature = (callback) => {
  const currentTemperature = getMarsTemperature(); //Salva a temperatura atual numa constante
  setTimeout(() => callback(currentTemperature), messageDelay()); //Executa a funcao callback com a temperatura como parametro
}
